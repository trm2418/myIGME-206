...
{
    // Method: Main
    // Purpose: Run math quiz
    //          Output: questions, final % score, prompt to play again
    // Restrictions: None
    static void Main()
    {
        // store user name
    ...
    start:
        ...
        for (nCntr = 0; nCntr < nQuestions; ++nCntr)
        {
            ...
            else
            {
                ...
                // tell user to input 2 decimal places
                sQuestions = $"Question #{nCntr + 1}: {val1} / {val2} (2 decimal places) => ";
            }
            ...
            do
            {
                ...
                try
                {
                    // convert user's input to a double and round to 2 decimal places
