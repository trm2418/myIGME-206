    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button3__Click(object sender, EventArgs e)
        {
            ...
            // 4. Your code here
            linkedList.AddBefore(linkedList.FindLast("fox"), "quick");
            linkedList.AddBefore(linkedList.FindLast("fox"), "brown");
            ...
            {
                // Add 'lazy' after 'the' (the LinkedListNode named linkedListNode).
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            linkedList.AddAfter(linkedListNode2, linkedListNode1.Value);
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            anagram.AddAfter(linkedListNode2, linkedListNode1.Value);
            ...
            linkedListNode1 = anagram.FindLast("M");
